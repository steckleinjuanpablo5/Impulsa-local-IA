  ...
  return (
    <div className={`rounded-xl border ${color} p-4`}>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          onClick={copy}
          className="p-1.5 rounded-lg hover:bg-black/5 transition-colors text-slate-500 hover:text-slate-700"
          aria-label={`Copiar texto para ${platform}`}
        >
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4 flex items-center gap-3">
        ...
        <div>
          <h3 className="text-white font-bold">Generador de contenido</h3>
          <p className="text-purple-200 text-xs">Demo de simulación — no usa IA real conectada</p>
        </div>
      </div>
